...
import 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import {
    ...
    setResponseStatus,
    toNodeListener
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/h3/dist/index.mjs';
import {
    createRenderer
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import {
    stringify,
    uneval
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/devalue/index.js';
import {
    renderToString
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/vue/server-renderer/index.mjs';
import {
    createFetch as createFetch$1,
    Headers
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/destr/dist/index.mjs';
import {
    createCall,
    createFetch
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/unenv/runtime/fetch/index.mjs';
import {
    createHooks
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/hookable/dist/index.mjs';
import {
    snakeCase
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/scule/dist/index.mjs';
import {klona} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/klona/dist/index.mjs';
import defu, {
    defuFn
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/defu/dist/defu.mjs';
import {hash} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/ohash/dist/index.mjs';
import {
    getQuery,
    joinURL,
    parseURL,
    withoutBase,
    withQuery
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/ufo/dist/index.mjs';
import {
    createStorage,
    prefixStorage
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs
    from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/unstorage/drivers/fs.mjs';
import {
    createRouter,
    toRouteMatcher
} from 'file:///Users/tanakritsupprasit/WebstormProjects/db-sus-project/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{
    "baseName": "server",
    "dir": "/Users/tanakritsupprasit/WebstormProjects/db-sus-project/server/assets"
}];
...
storage.mount('root', unstorage_47drivers_47fs({
    "driver": "fs",
    "readOnly": true,
    "base": "/Users/tanakritsupprasit/WebstormProjects/db-sus-project",
    "ignore": ["**/node_modules/**", "**/.git/**"]
}));
storage.mount('src', unstorage_47drivers_47fs({
    "driver": "fs",
    "readOnly": true,
    "base": "/Users/tanakritsupprasit/WebstormProjects/db-sus-project/server",
    "ignore": ["**/node_modules/**", "**/.git/**"]
}));
storage.mount('build', unstorage_47drivers_47fs({
    "driver": "fs",
    "readOnly": false,
    "base": "/Users/tanakritsupprasit/WebstormProjects/db-sus-project/.nuxt",
    "ignore": ["**/node_modules/**", "**/.git/**"]
}));
storage.mount('cache', unstorage_47drivers_47fs({
    "driver": "fs",
    "readOnly": false,
    "base": "/Users/tanakritsupprasit/WebstormProjects/db-sus-project/.nuxt/cache",
    "ignore": ["**/node_modules/**", "**/.git/**"]
}));
...
const _VaFcRA1cGD = (function (nitro) {
...
const _lazy_Q0NyOK = () => Promise.resolve().then(function () {
    return renderer$1;
});

const handlers = [
    {route: '/__nuxt_error', handler: _lazy_Q0NyOK, lazy: true, middleware: false, method: undefined},
    {route: '/**', handler: _lazy_Q0NyOK, lazy: true, middleware: false, method: undefined}
];
...
const getClientManifest = () => import('/Users/tanakritsupprasit/WebstormProjects/db-sus-project/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () {
    return _virtual__headStatic$1;
}).then((r) => r.default || r);
const getServerEntry = () => import('/Users/tanakritsupprasit/WebstormProjects/db-sus-project/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getSSRStyles = lazyCachedFunction(() => Promise.resolve().then(function () {
    return styles$1;
}).then((r) => r.default || r));
...
const getSPARenderer = lazyCachedFunction(async () => {
    const manifest = await getClientManifest();
    const spaTemplate = await Promise.resolve().then(function () {
        return _virtual__spaTemplate;
    }).then((r) => r.template).catch(() => "");
    const options = {
        manifest,
