...
<template>
    <v-container class="justify-center feature_container pb-2 mb-8">
        ...
        <v-row v-if="(status == 'authenticated' && data.role == 'MANAGER') || 1" class="feature_rounded mx-3 mt-8 px-5 py-8" justify="center" no-gutters>
            <v-col class="" col="">
        ...
        <v-row v-if="(status == 'authenticated' && (data.role == 'MANAGER' || data.role == 'GOD')) || 1" class="mt-5 px-3" justify="center">
