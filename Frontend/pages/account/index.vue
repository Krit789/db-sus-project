  ...
  <Navbar>
    <v-main class="bg-grey-lighten-4 justify-center windows_bg">
      <div class="main_container mx-auto">
        ...
        <div class="text-center my-10 ma-auto your_account user_rounded pa-4 mx-4">
          <v-card-text class="text-h3 font-weight-bold my-6  ">Manage Your Account</v-card-text>
          ...
          <v-btn v-if="editMode == true" class="ma-2" color="deep-purple-lighten-2" variant="outlined" @click.stop="">
            Save
          </v-btn>
