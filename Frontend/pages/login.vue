...
<template>
    <v-main class="mt-5">
        ...
        <v-card :loading="isCardLoading ? 'blue' : undefined" :width="mobile ? '100%' : '700px'" class="blur-effect account_pane my-2" v-if="wantLogin == true">
        ...
        <v-card :loading="isCardLoading ? 'blue' : undefined" :width="mobile ? '100%' : '700px'" class="blur-effect account_pane my-2" v-else>
