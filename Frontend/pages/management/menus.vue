                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col col="12" sm="6">
                                        <b>Image</b>
                                        <br />
                                        <v-img :src="item.raw.img_url ? item.raw.img_url : 'https://livingstonbagel.com/wp-content/uploads/2016/11/food-placeholder.jpg'" aspect-ratio="1/1" cover height="300" width="300"></v-img>
                                    </v-col>
                                </v-row>
                            </v-container>
                        </td>
