    ...
    <div class="main_container management_container mx-auto blur-effect">
      ...
      <v-sheet class="mt-8 ma-md-8 ma-sm-5 text-center" rounded="lg">
        ...
        <v-container>
          <v-row>
            <v-col>
              <v-data-table items-per-page="-1" :density="mobile ? 'compact' : 'comfortable'" :headers="dtHeaders" :items="dtData" :loading="dtLoading" :multi-sort="true" :search="dtSearch" class="elevation-1" item-value="res_id" height="40vh" sticky fixed-header>
                <template v-slot:top>
                  <v-card elevation="0">
