...
<template>
  <v-main class="justify-center ">
    <v-parallax class="main_parallax" src="/images/background/Wallpaper.webp">
            ...
            <v-stepper-window :touch="false">
              <v-stepper-window-item :disabled="hasLocation" value="1">
                <v-card title="">
                  ...
                  <v-btn :disabled="pageSpinner" class="align-right mb-3" prepend-icon="mdi-refresh" text="Refresh"
                         @click="loadLocation"></v-btn>
                  <!-- <v-btn
                        ...
                        <td :colspan="columns.length" class="text-left">
                          <v-container>
                            <v-row>
                              ...
                              <v-col col="12" sm="6">
                                <b>Address</b><br/>{{ item.raw.address }}
                              </v-col>
                            </v-row>
                          </v-container>
                        </td>
              ...
              <v-stepper-window-item value="2">
                <v-card>
                  ...
                  <v-container>
                    <v-row>
                      <v-col>
                        <v-btn v-if="!hasLocation" prepend-icon="mdi-arrow-left" variant="tonal"
                               @click="() => {resDateTime = null; stepper1--;}">
                          Back
                        </v-btn>
                      </v-col>
                      <v-col>
                        <v-btn :disabled="!(isDateTimeInRange() && isDateTimeInOperation())"
                               class="text-right"
                               prepend-icon="mdi-arrow-right"
                               @click="() => {stepper1++;findSeatforSelectedDT();}">
                          Next
                        </v-btn>
                      </v-col>
                    </v-row>
                ...
                <v-card>
                  ...
                  <v-container class="align-self-center">
                    <v-row>
                      <v-col>
                        ...
                        <v-img
                            :src="selectedLoc.layout_img_url"
                            class=""
                            width="600">
                      ...
                      <v-col>
                        ...
                        <v-text-field
                            v-model="resGuest"
                            :on-update:model-value="() => {selectedSeat = null;}"
                            :rules="[seatRule]"
                            min="1"
                  ...
                  <v-container>
                    <v-row>
                      ...
                      <v-col>
                        <v-btn :disabled="filterSeatCount == 0 || selectedSeat == null"
                               prepend-icon="mdi-arrow-right"
              ...
              <v-stepper-window-item value="4">
                <v-card>
                  ...
                  <v-container>
                    <v-row>
                      <v-col>
                        <v-btn prepend-icon="mdi-arrow-left" variant="tonal" @click="() => {stepper1--;}">
                          Back
                        </v-btn>
                      </v-col>
                      <v-col>
                        <v-btn prepend-icon="mdi-arrow-right" @click="() => {stepper1++;}">
                          Next
                        </v-btn>
                      </v-col>
                    </v-row>
                ...
                <v-card>
                  ...
                  <v-container>
                    <v-row>
                      ...
                      <v-col>
                        <v-btn color="success" prepend-icon="mdi-check" @click="() => {console.log('Confirm');}">
                          Confirm
                        </v-btn>
                      </v-col>
                    </v-row>
